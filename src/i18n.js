...
const translations = {
  ...
  'login.password.warning': { zh: '此方式可能触发 CAPTCHA 验证，建议使用 API Key 登录。', en: 'This method may trigger CAPTCHA verification. API Key login is recommended.' },
  ...
  'toast.network.lost': { zh: '网络已断开，操作可能失败', en: 'Network lost, operations may fail' },
  ...
  'credfile.security': { zh: '安全提示：凭证文件使用 AES-256-GCM 加密保护。请妥善保管文件密码，遗失后无法恢复。', en: 'Security: File is protected with AES-256-GCM encryption. Keep your file password safe—it cannot be recovered.' },
  ...
  'detail.btn.edit': { zh: '编辑条目', en: 'Edit Item' },
  ...
  'edit.save.server.old.fail': { zh: '新条目已创建，但旧条目删除失败，请手动删除', en: 'New item was created, but deleting the old item failed. Please delete it manually.' },
  ...
  'deadurls.unreachable': { zh: '无法访问', en: 'Unreachable' },
  ...
  'merge.report.partial': { zh: '合并完成（部分失败）', en: 'Merge Complete (Partial Failures)' },
  ...
  'decrypt.raw.check': { zh: '原始数据检查', en: 'Raw Data Check' },
  ...
  'credfile.view.security': { zh: '加密文件包含你的完整登录凭证，请妥善保管。仅本网站可解密。', en: 'The encrypted file contains your full login credentials. Keep it safe. Only this site can decrypt it.' },
